...
val dbDependencies = Seq(
  ...
  "org.flywaydb" % "flyway-database-postgresql" % "11.12.0" // database migrations
)
...
val jsonDependencies = Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.37.10" // automatic codec derivation
)
