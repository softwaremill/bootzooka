...
val dbDependencies = Seq(
  ...
  "org.flywaydb" % "flyway-database-postgresql" % "13.5.0" // database migrations
)
...
val jsonDependencies = Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.40.1" // automatic codec derivation
)

val loggingDependencies = Seq(
  "ch.qos.logback" % "logback-classic" % "1.6.3", // main logging library
  "org.slf4j" % "jul-to-slf4j" % "2.0.19", // forward e.g. OTEL and Magnum logs which use JUL to SLF4J
  "com.softwaremill.ox" %% "mdc-logback" % oxVersion, // support MDCs which propagate within Ox scopes
  "org.slf4j" % "slf4j-jdk-platform-logging" % "2.0.19" % Runtime // route Java's platform logging (separate from JUL) to SLF4J
)
