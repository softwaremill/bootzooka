...
val dbDependencies = Seq(
  ...
  "org.flywaydb" % "flyway-database-postgresql" % "12.9.0" // database migrations
)
...
val jsonDependencies = Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.38.15" // automatic codec derivation
)

val loggingDependencies = Seq(
  "ch.qos.logback" % "logback-classic" % "1.5.34", // main logging library
