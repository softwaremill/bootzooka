...
val dbDependencies = Seq(
  ...
  "org.flywaydb" % "flyway-database-postgresql" % "11.17.0" // database migrations
)
...
val jsonDependencies = Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.38.4" // automatic codec derivation
)

val loggingDependencies = Seq(
  "ch.qos.logback" % "logback-classic" % "1.5.21", // main logging library
