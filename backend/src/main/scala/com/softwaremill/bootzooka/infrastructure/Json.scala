...
import com.softwaremill.bootzooka.util.{HashedPassword, Id}
...
object Json extends AutoDerivation {
  ...
  implicit val passwordHashEncoder: Encoder[String @@ HashedPassword] =
    Encoder.encodeString.asInstanceOf[Encoder[String @@ HashedPassword]]
